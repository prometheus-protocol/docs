...
Welcome, security expert! This guide is for auditors and DAO members who form the human trust layer of the Prometheus Protocol. You are the gatekeepers of quality and security for the entire decentralized AI economy.
...
<Steps>
  <Step title="Finding Audits">
    Browse the Audit Hub, a real-time marketplace of services waiting for
    verification, each with a specific reward bounty.
  </Step>
  <Step title="Claiming & Performing Audits">
    Stake your reputation tokens to claim an audit, perform your off-chain
    analysis, and submit your on-chain attestation.
  </Step>
...
Ready to help secure the ecosystem? Let's start by finding your first audit.
