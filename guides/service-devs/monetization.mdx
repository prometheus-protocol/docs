...
<Step title="Initialize the Authentication Context">
    ...
    // URL of your service's frontend (for interactive login redirects)
...
### Optional: Enable Interactive Login for Web Apps

While API keys are ideal for scripts and backend services, you may also want to allow human users to log in through a browser-based flow (e.g., from the Prometheus App Store). To enable this, you must register your service as an OAuth client.
...
This command will interactively guide you through the registration process. Once complete, users will be able to log into your service using their standard Prometheus identity and wallets.

---

🎉 **Congratulations!** Your server is now a fully monetized service. You've enabled and tested programmatic access via API Keys and you know how to add browser-based login for interactive web apps.
