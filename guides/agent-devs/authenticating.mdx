...
Here’s what you and your users will experience when connecting to a protected service for the first time:

<Steps>
  <Step title="1. Connection is Attempted">
    Your application or SDK attempts to connect to the protected MCP server.
  </Step>
  <Step title="2. Login Prompt Appears">
  ...
  <Step title="3. User Grants Consent">
  ...
  <Step title="4. Connection Succeeds">
